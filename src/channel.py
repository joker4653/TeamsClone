...
from src.other import valid_user_id, valid_channel_id, user_info, validate_token, is_global_owner, update_user_stats
...
def channel_invite_v1(auth_user_id, channel_id, u_id):
    ...
    update_user_stats([u_id], "channels_joined", "num_channels_joined", 1)
...
def channel_leave_v1(token, channel_id):
    ...
    for owner in owner_ids:
        if owner['u_id'] == user_id:
            ...
            break
    update_user_stats([user_id], "channels_joined", "num_channels_joined", -1)
    data_store.set(store)
    write_data(data_store)
